...
class GlobalConfig:
    ...
    CHAT_USAGE_INSTRUCTIONS = (
        ...
        '[SlideDeck AI](https://github.com/raghavnarula/slide-deck-ai) is an Open-Source project,'
        ' released under the'
        ' [MIT license](https://github.com/raghavnarula/slide-deck-ai?tab=MIT-1-ov-file#readme).'
        ' It is is powered by'
        ...
        '---\n\n'
        '© Copyright 2023-2024 Raghav Narula.\n\n'
    )
